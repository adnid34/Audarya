			...
			<div class="wrapper">
				...
				<nav>
					<ul id="top_nav">
						...
						<li><a href="#"> </a></li>
						<li class="end"><a href="Contact.html"> </a></li>
					</ul>
				</nav>
				<nav>
					<ul id="menu">
						...
						<li><a href="ownregi.html">Reg</a></li>
...
<!-- content -->
		<article id="content">
			<div class="wrapper">
				<h2><strong>Achivement</strong></h2>
				<div class="box1">
			...
			<!-- / news code -->
			    <div class="container2">
				        ...
				        <div class="str4 str_wrap" style="height:200px;">
							...
							{
						?>
							<h6>Title: <?php echo $fetch['NewsTitle']; ?></h6>
							<p>
				            Description: <?php echo $fetch['NewsDetail']; ?>
				            </p>
				           <?php
							}
							?>
				        ...
				        <div class="str6 str_wrap" style="height:200px;">
				            <p>short text does not move</p>
				        </div>
             </div>
			...
			<div class="wrapper">
				<div class="box2">
					<div class="line1"><div class="line2 wrapper">
						...
						?>
						<section class="col1 pad_left1">
							<h4><span><?php echo $fetch['EventDate']; ?></span></h4>
							<p class="pad_bot2"><strong><?php echo $fetch['EventTitle'];  ?></strong></p>
							<p class="pad_bot2"><strong>Venue:</strong></p>
							<p><?php echo $fetch['Venue']; ?></p>
							<p><?php echo $fetch['EventDescription']; ?></p>
						</section>
						<?php
							}
						?>
